...
export default function HeaderAplicacao() {
    return (
        <header className="p-8 text-center bg-gradient-to-b from-red-100 to-white rounded-b-2xl shadow-md">
            ...
            <Button className="mt-4 px-8 py-5 text-lg font-bold bg-emerald-500 hover:bg-emerald-600 text-white rounded-full transition duration-300 shadow-lg cursor-pointer">
